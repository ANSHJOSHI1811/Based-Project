...
const InstanceDetailsTable = ({ data, openModal }) => {
  return (
    <div className="w-3/4 ml-4 bg-white shadow-2xl rounded-xl border border-gray-300 overflow-hidden">
      {/* Window Header */}
      <div className="bg-gray-200 p-2 flex items-center justify-between text-gray-700 font-semibold rounded-t-xl">
        <span className="ml-2">Instance Details</span>
      </div>
            ...
            {data.map((row, index) => (
              ...
              >
                <td className="p-4 flex items-center gap-3">
                  <img
                    src={row.ProviderID === 1 ? awsLogo : row.ProviderID === 2 ? azureLogo : null}
                    alt="Provider Logo"
