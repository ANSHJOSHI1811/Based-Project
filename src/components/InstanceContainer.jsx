...
const InstanceContainer = () => {
  ...
  useEffect(() => {
    ...
    if (selectedInstanceType) {
      ...
      console.log("Filtered by Instance type:", filteredRows);
    }
    ...
    if (selectedStorage) {
      ...
      console.log("Filtered by Storage:", filteredRows);
    }
    ...
    if (selectedOS) {
      ...
      console.log("Filtered by operating system:", filteredRows);
    }
...
<div>
          ...
          <select
            ...
            onChange={(e) => {
              console.log("Selected Instance Type:", e.target.value);
        ...
        <div>
          ...
          >
            ...
            {Array.from(new Set(data.map((row) => row.operatingSystem))).map(
              (os, index) => (
